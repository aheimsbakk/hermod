...
## Language & Runtime
Go 1.24+ (required for native X25519MLKEM768 / ML-KEM in crypto/tls)

## Key Dependencies
| Package | Purpose |
|---|---|
| `github.com/cloudflare/circl` | CPace RFC 9496 |
...
| `github.com/ncruces/go-sqlite3` | CGO-free SQLite |
